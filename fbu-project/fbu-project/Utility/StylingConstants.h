...
#define USER_PIN_COLOR [UIColor colorWithRed:255.0/255.0 green:0.0/255.0 blue:0.0/255.0 alpha:1.0]
#define VENUE_PIN_COLOR [UIColor colorWithRed:0.0/255.0 green:255.0/255.0 blue:0.0/255.0 alpha:1.0]
#define OPTIMAL_VENUE_PIN_COLOR [UIColor colorWithRed:255.0/255.0 green:215.0/255.0 blue:0.0/255.0 alpha:1.0]

//general
extern NSString * const DEFAULT_PROFILE_IMAGE_NAME;
